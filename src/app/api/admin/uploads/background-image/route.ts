...
// Stores an uploaded file (local filesystem in dev, private Vercel Blob in
// production) and hands back this app's own read-proxy URL, which the
// renderer can fetch like any other backgroundImageUrl — the "browse a
// file" path just uploads first and then behaves exactly like pasting a
// hosted image URL.
